...
public class PostgresProvider extends SQLProviderAdapter<PostgresGlobalState, PostgresOptions> {
    ...
    private enum DatabaseInitStmt implements AbstractAction<PostgresGlobalState> {
    ...
    private static int mapDatabaseInitStmt(PostgresGlobalState globalState, DatabaseInitStmt a) {
        Randomly r = globalState.getRandomly();
        switch (a) {
            case CREATE_INDEX:
    ...
    public void generateDatabase(PostgresGlobalState globalState) throws Exception {
        ...
        if (globalState.useWriteCheck()) {
            ...
            for (int i = 0; i < tableNum; ) {
                ...
                boolean success;
                try {
                    createTable = PostgresTableGenerator.generate(tableName, globalState.getSchema(),
                ...
                if (success) {
                    ...
                    StatementExecutor<PostgresGlobalState, DatabaseInitStmt> se = new StatementExecutor<>(globalState, DatabaseInitStmt.values(),
                            PostgresProvider::mapDatabaseInitStmt, (q) -> {
