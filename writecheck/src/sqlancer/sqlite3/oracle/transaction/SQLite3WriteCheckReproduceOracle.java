...
public class SQLite3WriteCheckReproduceOracle extends SQLite3WriteCheckOracle {

    public SQLite3WriteCheckReproduceOracle(SQLite3GlobalState state) {
        super(state);
    }
    ...
    public void check() throws SQLException {
        ...
        try {
            for (SQLite3Isolation.SQLite3IsolationLevel level : SQLite3Isolation.SQLite3IsolationLevel.values()) {
                SQLite3TxTestExecutor testExecutor = new SQLite3TxTestExecutor(state, transactions, schedule, level);
                ...
                SQLite3TxTestExecutor oracleExecutor = new SQLite3TxTestExecutor(state, transactions, oracleSchedule, level);
