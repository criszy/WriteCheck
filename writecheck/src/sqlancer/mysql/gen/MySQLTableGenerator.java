    ...
    private void appendTableOptions() {
        ...
        for (TableOptions o : tableOptions) {
            ...
            case AVG_ROW_LENGTH:
                ...
                sb.append(r.getLong(0, 4294967296L));  // The valid range for avg_row_length is [0,4294967295]
                break;
            case CHECKSUM:
...
//                String fromOptions = Randomly.fromOptions("InnoDB", "MyISAM", "MEMORY", "HEAP", "CSV", "ARCHIVE");
                String fromOptions = Randomly.fromOptions("InnoDB");
            ...
            case KEY_BLOCK_SIZE:
                ...
                sb.append(r.getLong(0, 65536));  // The valid range for key_block_size is [0,65535]
                break;
            case MAX_ROWS:
                sb.append("MAX_ROWS = ");
